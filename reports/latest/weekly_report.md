# Carbon Market Weekly — 2026-07-29

탄소배출권 시장 주간 브리핑 (EU ETS / 글로벌 / 캘리포니아 CCA 프록시).

![prices](carbon_prices.png)

## Snapshot

| ticker | last | ret_1w_% | ret_1m_% | vol_20d_ann_% | trend_vs_MA50 | signal |
| --- | --- | --- | --- | --- | --- | --- |
| GRN | 32.76 | 3.74 | 1.91 | 34.0 | UP | LONG |
| KCCA | 16.54 | -3.61 | -2.71 | 11.5 | DOWN | SHORT/AVOID |
| KEUA | 22.87 | 0.0 | 0.0 | 0.0 | n/a | STALE-DATA |
| KRBN | 33.74 | 1.78 | 0.75 | 24.1 | UP | LONG |

## Cross-market — EU vs California (relative value)

- KEUA/KCCA 비율 1.3827, 60일 z-score -0.32 → 중립 범위

## This week (draft)
- KRBN(글로벌/EU 배출권): LONG — 추세 UP, 1개월 0.75%
